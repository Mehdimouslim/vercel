...
<>{!isLoggedIn?(
  ...
  <div className="navbar-top">
            <div className="social-link">
                <i><a href="www.twitter.com"><img src="./image/twitter.png" alt="" width='30px' /></a></i>
                <i><a href="www.facebook.com"><img src="./image/facebook.png" alt="" width="30px"/></a></i>
                <i><a href="www.google.com"><img src="./image/google-plus.png" alt="" width="30px"/></a></i>
            </div>
            <div className="logo">
                <h3>Green Doum</h3>
            </div>
